---
title: 'docs.json reference: global settings and properties'
description: 'Reference for every docs.json property in Mintlify, including navigation, logo, colors, topbar links, footer, analytics, and integrations.'
icon: 'gear'
---
