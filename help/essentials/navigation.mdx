---
title: 'Configure docs navigation menus and tabs'
description: 'Configure the navigation menu in docs.json using tabs, groups, and nested pages, and learn how folder structure relates to page routing.'
icon: 'map'
---
