...
### From the Unscrambled Tabs extension

If you use the **Unscrambled Tabs** Chrome extension with a [connected eggz account](/help/unscrambled-tabs/eggz-account), you can upload without opening the web app:
...
<Tip>Don't have it yet? [Add Unscrambled Tabs to Chrome](https://chromewebstore.google.com/detail/unscrambled-tabs/gfjdjhpcemmakhoaggnihfcohkmfcfcc) — it's free, and it can even [capture bills from any page](/help/unscrambled-tabs/capture-bills) you're browsing.</Tip>
