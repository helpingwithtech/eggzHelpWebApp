---
title: "Quickstart: clone, preview, and publish your docs"
description: "Clone your docs repository, install the Mintlify CLI to preview locally, edit your first page, and publish changes to your live documentation site."
---
