...
3. Open **Settings** in the side panel to set **Performance mode**, **Protected domains**, and (if you use AI signed out) your **Anthropic API key** — or [connect your eggz account](/help/unscrambled-tabs/eggz-account) to use the CRM agent with no key.
