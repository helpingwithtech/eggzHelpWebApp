...
| **chrome.storage.session** | Short-lived UI state, per-window workspace map, the rolling list of recently-visited domains for the bill-capture nudge, and your per-conversation "always allow" AI permissions (all cleared when Chrome closes) |
