...
- In **eggz CRM** mode (signed in), the AI tab talks to **eggz** (your organization's CRM agent) — no API key needed.
- In **Tabs AI** mode (the local assistant — the only mode when signed out), **Anthropic** is only contacted when you use **AI** features and a valid **API key** is configured.
