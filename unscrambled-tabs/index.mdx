...
<CardGroup cols={2}>
  <Card title="Install the extension" icon="download" href="/unscrambled-tabs/install">
    Chrome Web Store, pinning the action, and optional developer load.
  </Card>

  <Card title="Workspaces & tabs" icon="folder-tree" href="/unscrambled-tabs/workspaces">
    How workspaces work, switching, and multi-window behaviour.
  </Card>

  <Card title="Performance & RAM" icon="gauge" href="/unscrambled-tabs/performance-and-ram">
    Manual, Balanced, and Aggressive modes; Free RAM; what never discards.
  </Card>

  <Card title="AI & search" icon="sparkles" href="/unscrambled-tabs/ai-and-search">
    AI assistant, keyboard search, and your API key (BYO).
  </Card>

  <Card title="Session Time-Travel" icon="clock-rotate-left" href="/unscrambled-tabs/session-time-travel">
    Auto-snapshots and restoring tab sets.
  </Card>

  <Card title="Backup & import" icon="floppy-disk" href="/unscrambled-tabs/backup-import">
    Encrypted backup, restore, and Workona import.
  </Card>

  <Card title="Settings & privacy" icon="shield-halved" href="/unscrambled-tabs/settings-privacy">
