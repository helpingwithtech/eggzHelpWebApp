...
The extension needs broad **tab** access to save workspaces, switch tabs, capture snapshots, and use discard. **Your browsing data stays local** to the extension unless you explicitly use features that send content to Anthropic (AI), which uses **your** API key. See [Settings & privacy](/unscrambled-tabs/settings-privacy) for detail.
